;(function (global, factory) {
    ...
    function arrow (a, b) {
        var c = b.element
        if (
            ('string' == typeof c && (c = a.instance.popper.querySelector(c)),
            !c)
        )
            return a
        ...
        return (
            ...
            g.forEach(function (h, i) {
                ...
                var j = getPopperClientRect(a.offsets.popper),
                    k =
                        ('left' === d &&
                            Math.floor(j.left) < Math.floor(c.left)) ||
                        ('right' === d &&
                            Math.floor(j.right) > Math.floor(c.right)) ||
                        ('top' === d &&
                            Math.floor(j.top) < Math.floor(c.top)) ||
                        ('bottom' === d &&
    ...
    function keepTogether (a) {
        ...
        return (
            -1 === ['top', 'bottom'].indexOf(e)
                ? (b.bottom < d(c.top) &&
                      (a.offsets.popper.top = d(c.top) - b.height),
                  b.top > d(c.bottom) && (a.offsets.popper.top = d(c.bottom)))
                : (b.right < d(c.left) &&
                      (a.offsets.popper.left = d(c.left) - b.width),
    ...
    function hide (a) {
        if (
            !isModifierRequired(a.instance.modifiers, 'hide', 'preventOverflow')
        )
            return (
                console.warn(
    ...
    var Popper = (function () {
        function Popper (a, b) {
            ...
            return (
                ...
                (this.modifiers = Object.keys(DEFAULTS.modifiers).map(function (
                    d
                ) {
