...
@push('css')
    ...
    <meta name="description" content="A bus seat reservation system made by Sangam">
    <meta name="author" content="Sangam Pradhan">
    ...
    <meta property="og:description" content="A bus seat reservation system made by Sangam" />
    <meta property="og:image:url" itemprop="image" content="A bus seat reservation system made by Sangam">
            ...
            <section class="body">
                <form id="date_form">
                    <fieldset class="animated fadeIn">
                        ...
                        <div class="justify-content-center row buttons">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 bus-details">
                                                    ...
                                                    <div class="m-b-10 row card-text bus-description">
                                                        ...
                                                        <div class="col-sm-6 fs-14">
                                                            ...
                                                            <span class="p-r-5 fr"><span class="seats-left">0</span> seats
                                                                left </span>
                                                        </div>
                                                        <div class="col-sm-6 fs-14">
                                                    ...
                                                    <div class="p-t-13">
                                                        ...
                                                        <a href="#" class="p-t-13 fr g-link">View Gallery</a>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-3 bus-image">
                                                        <img src="images/p.png" alt="bus" height="130"
                                                            width="130">
                                                    </div>
                                                    <div class="col-md-8 bus-details">
                                                        ...
                                                        <div class="p-t-13">
                                                            <a href="#"
                                                                ...
                                                                Seats</a>
                                                            <a href="#" class="p-t-10 fr">View Gallery</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-3 bus-image">
                                                        <img src="images/p3.png" alt="bus" height="130"
                                                            width="130">
                                                    </div>
                                                    <div class="col-md-8 bus-details">
                                                        <h5 class="card-title bus-name">KCK 122Y (<span
                    ...
                    <!-- END SEAT MAP -->
                    <!-- PERSONAL INFO -->
                    <fieldset class="p-info animated fadeIn">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" id="phone"
                                    placeholder="0712345678" onkeyup="verifyInfoForm()">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="d-flex justify-content-center row">
                            <div class="col-md-10">
                                <h6>
                                    ...
                                    upon payment completion. So please ensure you provide a valid email address. <br><br>
                                    <span class="note">Note: If you havent made a deposit by 3 days your reservation will
                                        be cancelled.</span>
                                </h6>
                            </div>
                        </div>
                    ...
                    <fieldset class="p-info animated fadeIn">
                        ...
                        <div class="d-flex justify-content-center row">
                            <div class="col-md-3" style="margin: auto;left: 0;top: 0;">
                                <img src="booked.png" alt="Success" class="p-b-10 img-fluid">
                            </div>
                            <div class="col-md-8">
                                <h6>
                                    An email has been sent to your email address (<span class="show-email"></span>). Don't
                                    forget to look in your spam folder. Safe Journey <i
                                        class="text-danger fa fa-heart"></i>.<br><br>
